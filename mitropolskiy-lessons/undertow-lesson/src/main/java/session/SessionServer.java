    ...
    public static void main(String[] args) {
        ...
        pathHandler.addPrefixPath("/", new HttpHandler() {
            public void handleRequest(HttpServerExchange exchange)
                ...
                System.out.println("in path /: sessionManager=" + sm);
                System.out.println("in path /: sessionCookieConfig=" + sessionConfig);
        ...
        pathHandler.addPrefixPath("/addToSession", new HttpHandler() {
            ...
            public void handleRequest(HttpServerExchange exchange)
              ...
              /*  Session session = sm.getSession(exchange, sessionConfig);
                ...
                Session session = sm.createSession(exchange, sessionConfig);

                System.out.println("in path /addToSession: sessionManager=" + sm);
                System.out.println("in path /addToSession: sessionCookieConfig=" + sessionConfig);
        ...
        pathHandler.addPrefixPath("/destroySession", new HttpHandler() {
            public void handleRequest(HttpServerExchange exchange)
                ...
                System.out.println("in path /destroySession: sessionManager=" + sm);
                System.out.println("in path /destroySession: sessionCookieConfig=" + sessionConfig);
        ...
        SessionManager sessionManager = new InMemorySessionManager(
                "SESSION_MANAGER");
        System.out.println("in main: sessionManager=" + sessionManager);
        SessionCookieConfig sessionConfig = new SessionCookieConfig();
        System.out.println("in main: sessionCookieConfig=" + sessionConfig);
        /*
